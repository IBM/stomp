...
class DAG:
    def __init__(self, graph, comp, atime, deadline, dtime, dag_type):
        ...
        with open(in_trace_name, 'r') as input_trace:
                ...
                for line in input_trace.readlines():
                    ...
                    if (line_count > 0):
                        ...
                        the_dag_trace = DAG(graph, comp, atime, deadline, dtime,dag_type)
            ...
            for dag_id in self.dag_id_list:
                ...
                for node,deg in the_dag_sched.graph.in_degree():
                    ...
                    if deg == 0 and node.scheduled == 0:
                        ...
                        task_entry.append((atime,task,dag_id,node.tid,deadline))
                        stimes = []
